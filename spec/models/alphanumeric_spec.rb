...
RSpec.describe Alphanumeric, type: :model do
  ...
  it "can decode cryptogram from Bottomless Pit"
    a = Alphanumeric.create
  ...
  it "can decode cryptogram from The Deep End"
    a = Alphanumeric.create
  ...
  it "can decode cryptogram from Carpet Diem"
    a = Alphanumeric.create
  ...
  it "can decode cryptogram from Boyz Crazy"
    a = Alphanumeric.create
  ...
  it "can decode cryptogram from Land Before Swine"
    a = Alphanumeric.create
  ...
  it "can decode cryptogram from Dreamscapers"
    a = Alphanumeric.create
  ...
  it "can decode cryptogram from Gideon Rises"
    a = Alphanumeric.create
